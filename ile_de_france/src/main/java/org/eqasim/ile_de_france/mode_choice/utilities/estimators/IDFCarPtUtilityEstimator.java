...
public class IDFCarPtUtilityEstimator extends CarPtUtilityEstimator {
	private final IDFModeParameters parameters;
	private final IDFPtPredictor predictor;


	@Inject
	public IDFCarPtUtilityEstimator(IDFModeParameters parameters, CarPtPredictor carPtPredictor, PersonPredictor personPredictor, IDFPtPredictor predictor) {
		super(parameters, carPtPredictor, personPredictor);
		this.parameters = parameters;
		this.predictor = predictor;
	}

	//BYIN 2025-01: only for IDF pt
