...
public class IDFCarPassengerRoadPricingPredictor extends CachedVariablePredictor<IDFCarPassengerRoadPricingVariables> {
    ...
    @Inject
    public IDFCarPassengerRoadPricingPredictor(Network network, PopulationFactory populationFactory) {
    ...
    @Override
    public IDFCarPassengerRoadPricingVariables predict(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
        ...
        return new IDFCarPassengerRoadPricingVariables(fee_toll, trip_commuting, trip_others);
    }
}
