...
public class RunSimulationCarPt_BaseCase {
	...
	static public void main(String[] args) throws ConfigurationException, IOException {
		args = new String[] {"--config-path", "ile_de_france/scenarios/ile-de-france-5pct/base_case/ile_de_france_config_adapt.xml"};
		...
		for (int i = 0; i < car_pt_constant.length; i++) {
			...
			config.controler().setOutputDirectory("E:/lvmt_BY/simulation_output/eqasim_idf/ile-de-france-5pct/PTCar_BaseCase_rer_train_" + car_pt_constant[i]);
