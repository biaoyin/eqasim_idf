...
public class PtBikeVariables implements BaseVariables{
    /*// CAR
    ...
    public PtBikeVariables(double travelTime_min, double inVehicleTime_min, double waitingTime_min, int numberOfLineSwitches,
