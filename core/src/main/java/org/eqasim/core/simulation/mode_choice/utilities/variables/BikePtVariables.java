...
public class BikePtVariables implements BaseVariables{
/*    // CAR
    ...
    public BikePtVariables(double travelTime_min,  double inVehicleTime_min, double waitingTime_min, int numberOfLineSwitches,
